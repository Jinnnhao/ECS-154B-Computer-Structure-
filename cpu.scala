...
class PipelinedCPU(implicit val conf: CPUConfig) extends BaseCPU {
  ...
  // hazard.io.idex_memread := id_ex_ctrl.io.data.mem_ctrl.memop(1,0)
  ...
  {
    ex_mem.io.in.nextpc       := ex_mem.io.data.nextpc 
    ex_mem.io.in.taken        := ex_mem.io.data.taken
    ex_mem.io.in.result       := ex_mem.io.data.result
    ex_mem.io.in.operand2     := ex_mem.io.data.operand2
    ex_mem.io.in.sextImm      := ex_mem.io.data.sextImm
    ex_mem.io.in.instruction  := ex_mem.io.data.instruction
  }
  ...
  {
    ex_mem_ctrl.io.in.mem_ctrl.memop  := ex_mem_ctrl.io.data.mem_ctrl.memop
    //  - Set the writeback control signals
    ex_mem_ctrl.io.in.wb_ctrl.writeback_valid   := ex_mem_ctrl.io.data.wb_ctrl.writeback_valid
    ex_mem_ctrl.io.in.wb_ctrl.writeback_src     := ex_mem_ctrl.io.data.wb_ctrl.writeback_src
  }
